...
void solve(int v, int n, int s[], int r[], int map[]){
...
for(int i=0; i<t; i++){
int n[t], v[t];  //v is the number of charactes and also the number of vertices on test case t

scanf("%d %d", &n[t], &v[t]); //input number of vertices v
...
for(int i=0; i<n; i++){
  scanf("%d",&s[i][t]); //input a string of characters of length n
  }

for(int i=0; i<n; i++){
  scanf("%d",&r[i][t]); //input a string of characters of length n
  }
